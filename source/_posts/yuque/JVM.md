...
JVM 结构：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/fa45c3fcfbfd3fd5e0d44ff4c7601a43.png)
JVM、JRE、JDK 对比：
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/0891880b460fe367e217da7b2572cc76.png)
...
- Java1.8 以前的内存结构图：![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/2413f446e615f2a6d5b29704ea59ac22.png)
- Java1.8 之后的内存结果图：![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/f61e6ac0afa93435bd0d06a03c9c71c3.png)
...
- 每个栈由多个栈帧（Frame）组成，对应着每次方法调用时所占用的内存，每个栈帧中存储着：
   ...
   - 操作数栈或表达式栈和其他一些附加信息
- ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/14040ecb0307410767695076325a0f5e.png)
...
- 为了支持当前方法的代码能够实现动态链接，每一个栈帧内部都包含一个指向运行时常量池或该栈帧所属方法的引用![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/d0cfcbe8bef28ccae3dcb0e70343ee0c.png)
- 在 Java 源文件被编译成的字节码文件中，所有的变量和方法引用都作为符号引用保存在 class 的常量池中常量池的作用：提供一些符号和常量，便于指令的识别![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/8abc9226f073e2d8212145b51d9d6c56.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/1871d19ec6b8f5cfbbef2d873e25835b.png)
...
本地内存概述图：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/55fe582cea443b975f883b09dce7b908.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/678bf6211f7dc005dd2f76800398904b.jpeg)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/ddd67376615ecacff646c3750cf228a1.jpeg)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/873faab384f6692a236787595f170168.png)
...
```
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/25b3464076634e4303159ceaea919bdc.png)
...
- 在可达性分析算法中，只有能够被根对象集合直接或者间接连接的对象才是存活对象![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/ffa1107c12db63916f4daae8c9d50713.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/77261eb8953c97e824e1757ce9c480d7.gif)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/0b073c4ee45ac3e2597142e1c8bedf89.png)
**漏标情况：**
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/f6be9d36ebd5117486f1641f778da53d.png)
代码角度解释漏标：
```
...
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/b908690b787f94a6e67ba042d40f3824.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/1ee9c5a31ae62440f40407486147cff2.png)
算法优点：
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/cf9909ede39057412b71f4b3b0932014.png)
...
优点：不会产生内存碎片
缺点：需要移动大量对象，处理效率比较低
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/922e550a3e9847c4376a3585edde5766.png)
...
**垃圾收集器的组合关系**：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/47151df77a8094f1b81394146c8112cd.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/64151173672f7102e3c09f7c141ade13.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/d48836456ec2fe328283eb74b88b695c.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/719d17b0148b678c7991bee48b246b33.png)
参数配置：
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/3dc444144f64b1509daafe002d5fd2f7.png)
优点：并发收集、低延迟
缺点：
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/bcefea7456bf6fb8a92e0d2b9c8831dc.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/2f28a170640ae08713af150b630f1e91.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/d38991dd811a0e26cbba883082b850c1.png)
...
- ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/338c545e6edca38206f9e05d4e20f76b.jpeg)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/10c7b12bd11ee69ce33f9746888910cc.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/ea72be8dfc3fed9aafa4b54eb95aebc3.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/780cfc61d31c94ea35914209af4868aa.png)
...
- 句柄访问：Java 堆中会划分出一块内存来作为句柄池，reference 中存储的就是对象的句柄地址，而句柄中包含了对象实例数据和类型数据各自的具体地址信息优点：reference 中存储的是稳定的句柄地址，在对象被移动（垃圾收集）时只会改变句柄中的实例数据指针，而 reference 本身不需要被修改![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/9f3ced871b8b1f60f48633e3b59b6a08.png)
- 直接指针（HotSpot 采用）：Java 堆对象的布局必须考虑如何放置访问类型数据的相关信息，reference 中直接存储的对象地址优点：速度更快，**节省了一次指针定位的时间开销**缺点：对象被移动时（如进行 GC 后的内存重新排列），对象的 reference 也需要同步更新![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/5a6955446e231db07bda0304e0b5f9f2.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/98cf06e4fe54a5ad09c7c5aa86443c55.png)
包括 7 个阶段：
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/f65f8da8f54f7285f22bb557ebea0a6c.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/e98047286ec30d67bf7328b8f3c83afe.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/8da7e0aff495f29e5365c07bde4d9fb9.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/304ddedbce5612daa9bd0f90fafdaacc.png)
...
### 执行过程
Java 文件编译执行的过程：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/d537dcc106deb9737069a53ad80aa998.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/374b88bc98647002b4e5da4247cad667.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/377512f7ab66f8dadd50c1b01ec3b620.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/1a79e0b076426ef1ab91118bb18a0cf7.png)
...
- istore_1：将操作数栈顶数据弹出，存入局部变量表的 slot 1![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/795c75cfc8a7b75155fa25183a25fcce.png)ldc #3：从常量池加载 #3 数据到操作数栈Short.MAX_VALUE 是 32767，所以 32768 = Short.MAX_VALUE + 1 实际是在编译期间计算完成![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/b797bfc3173807f8f1a30e3a94ba8da3.png)istore_2：将操作数栈顶数据弹出，存入局部变量表的 slot 2iload_1：将局部变量表的 slot 1 数据弹出，放入操作数栈栈顶iload_2：将局部变量表的 slot 2 数据弹出，放入操作数栈栈顶iadd：执行相加操作![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/6d604ede4b3d524e5f4f9fc8c590635e.png)istore_3：将操作数栈顶数据弹出，存入局部变量表的 slot 3getstatic #4：获取静态字段![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/f393f6b9f6e0bc4b2a91fba892d7f39c.png)iload_3：![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/e38b4c47c55a5b905af8335020633959.png)invokevirtual #5：
   - 找到常量池 #5 项
   ...
   - 执行完毕，弹出栈帧
   - 清除 main 操作数栈内容
- ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/a12926def21b223011235cc96ba71c31.png)return：完成 main 方法调用，弹出 main 栈帧，程序结束
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/8995bdc873405d71dfe1110d6daa4917.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/5b6ad8248b02bcc28e339b013bc13792.png)
...
```
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/fe3e200d2d31af46d0265b6b35e2cd6a.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JVM/a4edaaf2766e735d3c2395b81bbcd18e.png)
