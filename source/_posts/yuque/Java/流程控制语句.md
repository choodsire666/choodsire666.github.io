---
title: 流程控制语句
urlname: dn0sow0d3pxdk7bf
date: '2024-03-31 10:45:57'
updated: '2024-05-28 19:11:30'
description: 本章专题与脉络流程控制语句是用来控制程序中各语句执行顺序的语句，可以把语句组合成能完成一定功能的小逻辑模块。程序设计中规定的三种流程结构，即：顺序结构程序从上到下逐行地执行，中间没有任何判断和跳转。分支结构根据条件，选择性地执行某段代码。有if…else和switch-case两种分支语句。循...
cover: ''
---
## 本章专题与脉络
...
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836609.png#clientId=u0f02a914-9265-4&from=url&id=DmNXD&originHeight=361&originWidth=201&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u0faff3e3-2cfa-46da-9b77-fe08f06b890&title=)
```java
...
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836610.png#clientId=u0f02a914-9265-4&from=url&id=owC7h&originHeight=365&originWidth=281&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=ubf67c9e9-09c0-4780-a1e5-11050891ed1&title=)
**结构2：双分支条件判断：if...else**
格式：
```java
if(条件表达式) { 
...
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836611.png#clientId=u0f02a914-9265-4&from=url&id=RO44q&originHeight=378&originWidth=321&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u71a8f8c3-37e1-4b11-85b7-db920c7286a&title=)
...
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836612.png#clientId=u0f02a914-9265-4&from=url&id=gmfcl&originHeight=567&originWidth=637&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u4e6b7041-af07-4f1c-a53f-ca13858cee0&title=)
#### 2.1.2 应用举例
...
```
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836613.png#clientId=u0f02a914-9265-4&from=url&id=JLD3U&originHeight=409&originWidth=1071&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=ud4e403d5-55c7-4266-b69d-45362df024c&title=)
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836614.png#clientId=u0f02a914-9265-4&from=url&id=xYoiA&originHeight=375&originWidth=928&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u4f060bf2-9126-49d3-a781-97afed32183&title=)
...
```
**执行流程图：**
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836615.png#clientId=u0f02a914-9265-4&from=url&id=ON9tY&originHeight=619&originWidth=1286&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u4b1bd514-335c-458b-b1d2-ac1d3345a13&title=)
**执行过程：**
...
**执行过程：**①-②-③-④-②-③-④-②-③-④-.....-②
**图示：**
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836618.png#clientId=u0f02a914-9265-4&from=url&id=FHohM&originHeight=458&originWidth=555&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u5e57797c-88e0-4da3-a207-21e162c6bb1&title=)
**说明：**
...
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836619.png#clientId=u0f02a914-9265-4&from=url&id=ohc97&originHeight=446&originWidth=626&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=u9df4cef5-8140-4d33-a18e-31617fe0110&title=)
```java
...
**执行过程：**①-②-③-④-②-③-④-②-③-④-...-②
**图示：**
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836618.png#clientId=u0f02a914-9265-4&from=url&id=GTcB4&originHeight=458&originWidth=555&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=uff50b54b-57fa-42ea-b495-7629f98046e&title=)
**说明：**
...
**执行过程：**①-③-④-②-③-④-②-③-④-...-②
**图示：**
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836620.png#clientId=u0f02a914-9265-4&from=url&id=iU9SO&originHeight=549&originWidth=531&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=ubd357e6e-7361-41aa-be49-92016d20782&title=)
**说明：**
...
```
**案例5：九九乘法表**
![](https://gitee.com/lvweixing/pictures/raw/master/202304241836622.png#clientId=u0f02a914-9265-4&from=url&id=mz9UZ&originHeight=239&originWidth=716&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&taskId=ue6aff1f4-bc6a-47b0-995f-46fece763d9&title=)
```java
