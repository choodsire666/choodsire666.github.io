---
title: JDK8-17新特性（下）
urlname: brykk7yxi6t2
date: '2024-03-13 17:15:40'
updated: '2024-05-19 17:36:23'
cover: ''
description: 第18章_JDK8-17新特性（下）6. 新语法结构新的语法结构，为我们勾勒出了 Java 语法进化的一个趋势，将开发者从复杂、繁琐的低层次抽象中逐渐解放出来，以更高层次、更优雅的抽象，既降低代码量，又避免意外编程错误的出现，进而提高代码质量和开发效率。6.1 Java的REPL工具： jSh...
---
# 第18章_JDK8-17新特性（下）
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321336789-13f948b6-5d53-46b6-aeee-f907c6091fa8.png#averageHue=%23171717&id=KFkts&originHeight=59&originWidth=331&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 获取帮助

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321336887-b68f7e96-b7bb-4459-b000-b8275d0247bc.png#averageHue=%230c0c0c&id=MhtqU&originHeight=190&originWidth=529&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 基本使用

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321336993-91efef30-d1ef-40b2-8518-4016d7ee25e6.png#averageHue=%230a0a0a&id=qX511&originHeight=420&originWidth=432&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 导入指定的包

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337145-0fa0ab80-4644-4aa8-afe1-985db11ae18f.png#averageHue=%230d0d0d&id=jIeSU&originHeight=32&originWidth=256&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 默认已经导入如下的所有包：（包含java.lang包）

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337229-9f70493d-7139-4ca7-9d8c-09ab69cb4045.png#averageHue=%23111111&id=AfXoS&originHeight=191&originWidth=296&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 只需按下 Tab 键，就能自动补全代码

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337349-099dae41-2ea3-4cfd-9784-b18e3a20fa3d.png#averageHue=%23080808&id=xJuMd&originHeight=205&originWidth=576&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 列出当前 session 里所有有效的代码片段

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337457-93c4b0eb-842f-4301-aa5b-c7c829b4488c.png#averageHue=%23090909&id=ft7BW&originHeight=145&originWidth=318&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 查看当前 session 下所有创建过的变量

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337557-44ff615b-8138-4c27-b48a-2d0f4e7400c5.png#averageHue=%23080808&id=Q3P1c&originHeight=69&originWidth=205&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 查看当前 session 下所有创建过的方法

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337643-46ed3690-d167-45a7-8713-58c933e7ca60.png#averageHue=%230c0c0c&id=Y75cr&originHeight=73&originWidth=197&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337743-beee588d-f6f2-4903-bcc0-ca967fc1f665.png#averageHue=%23070707&id=b47Uj&originHeight=207&originWidth=283&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337836-5dc86b45-fdf5-4e07-b216-46918219f444.png#averageHue=%230f0f0f&id=SAuk5&originHeight=73&originWidth=415&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 退出jShell

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321337921-71fe6d1e-a90a-4431-8ed6-b64ec628cd6a.png#averageHue=%230b0b0b&id=FBNI3&originHeight=46&originWidth=149&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338016-15c23541-c122-40db-abd1-76774f369736.png#averageHue=%230d0d0d&id=rRxHU&originHeight=81&originWidth=372&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

声明一个数组变量，并为数组静态初始化（省略new的情况下）

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338107-1a2b456f-587f-43e1-83ab-eaed1addf24e.png#averageHue=%23161616&id=ZmCuz&originHeight=89&originWidth=365&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

没有初始化的方法内的局部变量声明

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338385-135262ae-3a15-4a58-bbb8-b6c1f86d0abf.png#averageHue=%23111111&id=oiWYs&originHeight=72&originWidth=378&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

方法的返回值类型

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338474-0db4f9d7-b37d-464c-8963-026b43f57fac.png#averageHue=%230b0b0b&id=ZI15d&originHeight=93&originWidth=372&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

方法的参数类型

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338560-b7d2d56b-7c1b-4211-93ab-a6d87aab7fe4.png#averageHue=%230e0e0e&id=LxDEX&originHeight=63&originWidth=372&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

构造器的参数类型

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338717-ec024044-39c7-45a2-963f-d2357e49b0df.png#averageHue=%230c0c0c&id=BXOI1&originHeight=138&originWidth=372&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

作为catch块中异常类型

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338813-3eede8e1-1fec-460c-97b6-6d0d98fc6a0d.png#averageHue=%230d0d0d&id=uM2Ht&originHeight=129&originWidth=372&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

Lambda表达式中函数式接口的类型

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321338980-ebe4b90c-f39e-4ac4-8669-b3b2be1d8f10.png#averageHue=%23131313&id=UsQMP&originHeight=132&originWidth=367&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

方法引用中函数式接口的类型

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321339061-ae1c36d8-07ed-4e5f-a43d-f6f9523e18b4.png#averageHue=%23161616&id=sXYcj&originHeight=87&originWidth=372&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321339170-79fe561f-dac9-48d8-b0b1-9133578e6cc6.png#averageHue=%23f7f6ec&id=fer9T&originHeight=120&originWidth=457&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321339271-591482cc-0559-43a2-9def-5f8bc0a6ffb4.png#averageHue=%23222222&id=RCVL4&originHeight=529&originWidth=329&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321339472-1eced660-0ef5-4465-8854-a54d6ffb409d.png#averageHue=%23eaeaea&id=vFAUz&originHeight=174&originWidth=774&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321339592-af7de995-94ec-4ea0-991f-e3bf62cd04bd.png#averageHue=%23f4f4f4&id=C13rD&originHeight=404&originWidth=615&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

![](https://cdn.nlark.com/yuque/0/2024/png/29688613/1710321339708-a61b8a16-614a-4ad2-bd60-8439243f03a2.png#averageHue=%23f7f7f7&id=ATKRQ&originHeight=390&originWidth=764&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
