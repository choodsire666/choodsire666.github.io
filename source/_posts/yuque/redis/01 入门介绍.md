...
cover: 'https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/9815be873ef3f831f1e2b52c2db72bff.png'
...
```
**安装成功如下图所示：**
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/82c1d41b2c13edec57293f7297989f26.png)
## 3.3 正式安装Redis
**① 将**`**redis-6.2.6.tar**`**上传至**`**/usr/local/src**`**目录**
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/73347d3d160ad68724dc6fb8fdbed667.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/1e920a7cfeab17f5ea4c6c7c2eb8e17a.png) 
## 3.4 启动Redis
...
```
 **启动成功如下图所示**
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/82a62d6a64d84c4197e77214ff2120e1.png) 
### 3.4.2 后台启动
**不推荐**
...
docker pull redis
```
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/b765b53a639d5d8d7754563ff644d914.png)
...
```
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/b800c233d02a7e561239510c8e8c6060.png)

3. 进入容器
```java
docker exec -it 4ddcd2e80eac /bin/bash
```
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/77d541597624bbc36bea62f801f7b017.png)

4. 连接redis
```java
redis-cli -h 127.0.0.1 -p 6379
```
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/01 入门介绍/4d1d15b7e91b37f584a21d75f4985aa5.png)
