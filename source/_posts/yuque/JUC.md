...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/4c6b3705f8646c9315b99f465dfc4a1c.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/9cfb47d83dc9cb0a014d0e7501c9712f.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/5d254764912e61f50cf85bb74c24280e.png) 
-  64 位虚拟机 Mark Word：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/3045824fb40f370bcb82bebe06779760.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/9865bf2e1d0238dbb309da4243881511.png)
- 在 Thread-2 上锁的过程，Thread-3、Thread-4、Thread-5 也执行 synchronized(obj)，就会进入 EntryList BLOCKED（双向链表）
- Thread-2 执行完同步代码块的内容，根据 obj 对象头中 Monitor 地址寻找，设置 Owner 为空，把线程栈的锁记录中的对象头的值设置回 MarkWord
- 唤醒 EntryList 中等待的线程来竞争锁，竞争是**非公平的**，如果这时有新的线程想要获取锁，可能直接就抢占到了，阻塞队列的线程就会继续阻塞
- WaitSet 中的 Thread-0，是以前获得过锁，但条件不满足进入 WAITING 状态的线程（wait-notify 机制）

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/1f2a66293ad2f03f899c3eaec6d23d7d.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/6ab0b50a53c6d8e5986b02b1310fe337.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/d5d4ccd90c704a345f75061111374e31.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/cec3652c4733180279a6ce78c221ff76.png) 
-  让锁记录中 Object reference 指向锁住的对象，并尝试用 CAS 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录 
-  如果 CAS 替换成功，对象头中存储了锁记录地址和状态 00（轻量级锁） ，表示由该线程给对象加锁
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/9406fef1e00cb98764d291a7b74e4859.png) 
-  如果 CAS 失败，有两种情况： 
   - 如果是其它线程已经持有了该 Object 的轻量级锁，这时表明有竞争，进入锁膨胀过程
   - 如果是线程自己执行了 synchronized 锁重入，就添加一条 Lock Record 作为重入的计数

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/ce94517e312fd40434c8d1e4599bf910.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/496b7c0172c682a54fbc24f7ee037538.png) 
-  Thread-1 加轻量级锁失败，进入锁膨胀流程：为 Object 对象申请 Monitor 锁，**通过 Object 对象头获取到持锁线程**，将 Monitor 的 Owner 置为 Thread-0，将 Object 的对象头指向重量级锁地址，然后自己进入 Monitor 的 EntryList BLOCKED
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/05225ebe319ad175a54829ff21d090d7.png) 
...
-  自旋成功的情况：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/8546f2213c61a67a631bb4381355ef35.png) 
-  自旋失败的情况： ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/5059d8c1743731b60bb69507d382251e.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/6ffe21b65b804729641f917a8dcd03b8.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/3ed963560616ff241b13720d57eadc08.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/9cab1c69439ced813decbc043746ccf3.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/c93ed14012ef04be33924267a9a55194.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/44c27c0a04b23e67f15968e2ce50562e.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/064f021e1d1480540d6b1b85017eb9c7.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/251b49a838dc2ccfa41a7d12bad76b7e.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/015fd6790a26095e5e6570de2d561b77.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/f6b62e7c0484dcad67a221a034fd8de4.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/3fff6c832d1681aacdc0581ca81fe4df.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0aecd293a2a37a413d74322a81f200e6.png)
...
```
 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0679f34a36a8c40a4c8986fc77a3bb9e.png) 
...
2: iinc		1, 1
```
 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/ba6ac5491b615cba81c64d5e71a40bc3.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/c3d9bea43ec7496603d3ba72f9c754fc.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/7f90745cc28db97d96100c1c9db7d4c3.png)

@sun.misc.Contended：防止缓存行伪共享，在使用此注解的对象或字段的前后各增加 128 字节大小的 padding，使用 2 倍于大多数硬件缓存行让 CPU 将对象预读至缓存时**占用不同的缓存行**，这样就不会造成对方缓存行的失效

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/de1bfdfed677e4f76190417f2a2ccbdf.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/87afd4313ec7cf52d7ec61b78af29506.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/6867ff57f7886d848f90e292b63c22b0.png)
...
```
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/02b27a45ad560f342b52f686dfe599f5.png)
```java
...
```
 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/14713a02ae197c2e67b46a13248027d3.png) ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/bbded5cc5ba28cdee3a77d55559c0411.png) 
...
参考视频：[https://space.bilibili.com/457326371/](https://space.bilibili.com/457326371/)
...
-  如果 key 使用强引用：使用完 ThreadLocal ，threadLocal Ref 被回收，但是 threadLocalMap 的 Entry 强引用了 threadLocal，造成 threadLocal 无法被回收，无法完全避免内存泄漏 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/dddc1a09a6ac7181d35183cc1f0b95ca.png) 
-  如果 key 使用弱引用：使用完 ThreadLocal ，threadLocal Ref 被回收，ThreadLocalMap 只持有 ThreadLocal 的弱引用，所以threadlocal 也可以被回收，此时 Entry 中的 key = null。但没有手动删除这个 Entry 或者 CurrentThread 依然运行，依然存在强引用链，value 不会被回收，而这块 value 永远不会被访问到，也会导致 value 内存泄漏 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/7dbfb48aec43c3c428e8b054761dd559.png) 
-  两个主要原因： 
   - 没有手动删除这个 Entry
   - CurrentThread 依然运行
...
参考文章：[https://blog.csdn.net/feichitianxia/article/details/110495764](https://blog.csdn.net/feichitianxia/article/details/110495764)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/c6d8c94f9df2aa7543f7807737a20a4d.png) 
...
-  `h = head` → `first = h.next`
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/03063a8d2d90a530c3bc41aab54636e7.png) 
-  `h.next = h` → `head = first`
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/26784635cfba304c9b3f6739f08272e4.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/89caa250550efc8ea6bfcab381ae2ae0.png)
...
图片来源：[https://space.bilibili.com/457326371/](https://space.bilibili.com/457326371/)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0d11ffb55b15b49a37d0055536c1e32d.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/ac8b98ebdd255a3ab024626a881d88fc.png) 
...
CLH 是一种基于单向链表的**高性能、公平的自旋锁**，AQS 是将每条请求共享资源的线程封装成一个 CLH 锁队列的一个结点（Node）来实现锁的分配 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/eff02a870ebe341788dffa9feadeb88c.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/a328266e357b2fc93985c8a86e8f6a76.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/c3362862f80b3eb9291e1fdf381dc704.png)
...
```
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/8ec23ccb5aa6721e3077dc4f494cd90f.png)
...
-  再有多个线程经历竞争失败后：
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/01b899e32863142b49dac5ab69200bac.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/792402a2513674bb1d69d227c74544b9.png)

-  如果这时有其它线程来竞争**（非公平）**，例如这时有 Thread-4 来了并抢占了锁 
   - Thread-4 被设置为 exclusiveOwnerThread，state = 1
   - Thread-1 再次进入 acquireQueued 流程，获取锁失败，重新进入 park 阻塞

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0e6da0b02a4d1e0f969653a4f5ef8d6b.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/cc9f0943985407b81fe3382a1c57b129.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/597467b79697bf255358f41a80401798.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/fe64f516bfb0064a8a9b9cd97e5777c7.png) 
...
-  补充情况：查询线程 A 查询数据时恰好缓存数据由于时间到期失效，或是第一次查询 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/8d5c269fbc06bcd3b54d584611e08da7.png) 
...
如果没有成功，在 doAcquireShared 内 for (;;) 循环一次，shouldParkAfterFailedAcquire 内把前驱节点的 waitStatus 改为 -1，再 for (;;) 循环一次尝试 tryAcquireShared，不成功在 parkAndCheckInterrupt() 处 park ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0dd83ef799ed42a7217aaa0bc70cc5d9.png) 

-  这种状态下，假设又有 t3 r.lock，t4 w.lock，这期间 t1 仍然持有锁，就变成了下面的样子
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/3975c347e4b450cfb794833de3b0db24.png) 
...
```
 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/2c4a35b8fd92de4777bdd78a263f94a9.png) 
...
-  t4 在 acquireQueued 中 parkAndCheckInterrupt 处恢复运行，再次 for (;;) 这次自己是头节点的临节点，并且没有其他节点竞争，tryAcquire(1) 成功，修改头结点，流程结束 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/6117e6a45aa0d82140704f010e9e7c9c.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/97b11b0468b9b14b59d95b933975c752.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/f986488103dcde4da025331dd8358079.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/92eb05534797203742cab7861d93b71d.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/fbabba258114f312aa3e0f2ba7c28971.png)
...
B站视频解析：[https://www.bilibili.com/video/BV1n541177Ea](https://www.bilibili.com/video/BV1n541177Ea)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/7ae2a92688e9ecbe06dbf47241a0e942.png) 
...
![]([https://seazean.oss-cn-beijing.aliyuncs.com/img/Java/JUC-ConcurrentHashMap](https://seazean.oss-cn-beijing.aliyuncs.com/img/Java/JUC-ConcurrentHashMap) 1.7底层结构.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/f5519a0ef33d537d2be4b1a8cb0e7c4e.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/bd4221c2589b85119b30b37de255cde4.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0fc37b4eac3efb363b1479cb85a7e66b.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/5419acf437644a8bfb6421ec943b57be.png) 
...
参考文章：[https://my.oschina.net/u/3768341/blog/3135659](https://my.oschina.net/u/3768341/blog/3135659)

参考视频：[https://www.bilibili.com/video/BV1Er4y1P7k1](https://www.bilibili.com/video/BV1Er4y1P7k1)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/797020b91d4083a0267bdc5eb2622fef.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/ebf9ded79588125ed916b42d737963e4.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/b221e53270dd335380792f807e720300.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/7df9e1a08e02d63f40221a99766c112b.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/92ff4ef093d9c345f7c99d1024f7407d.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/d439fc88605dd7723649a26656485e7f.png)

如果这时，有一个线程来添加元素，通过 tail 获取的 next 节点则仍然是它本身，这就出现了p == q 的情况，出现该种情况之后，则会触发执行 head 的更新，将 p 节点重新指向为 head

参考文章：[https://www.jianshu.com/p/231caf90f30b](https://www.jianshu.com/p/231caf90f30b)
...
参考视频：[https://www.bilibili.com/video/BV1kT4y1M7vt](https://www.bilibili.com/video/BV1kT4y1M7vt)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/b90f1ada0f439db6abc9eb0e96b9ee8d.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/61d85f39c6bf23c062f461932b6e0436.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/0dfb75628b37cf386a634b38f24e837b.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/46bf51a7de6f787adb73effba77a6d3c.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/930bd3cdcf64ca8ecab2f936df458978.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/6762a276c19f420303a1927471deb124.png)
...
参考文章：[https://www.cnblogs.com/anker/p/3265058.html](https://www.cnblogs.com/anker/p/3265058.html)

其他流程图：[https://www.processon.com/view/link/5f62b9a6e401fd2ad7e5d6d1](https://www.processon.com/view/link/5f62b9a6e401fd2ad7e5d6d1)
...
参考文章：[https://github.com/CyC2018/CS-Notes/blob/master/notes/Socket.md](https://github.com/CyC2018/CS-Notes/blob/master/notes/Socket.md)
...
流程图：[https://gitee.com/seazean/images/blob/master/Java/IO-epoll原理图.jpg](https://gitee.com/seazean/images/blob/master/Java/IO-epoll%E5%8E%9F%E7%90%86%E5%9B%BE.jpg)
...
参考文章：[https://www.jianshu.com/p/dfd940e7fca2](https://www.jianshu.com/p/dfd940e7fca2)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/b7676147a42f8d1684fb95ff9359abcf.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/e945a074c6b849006a01ad5ac0c9df51.jpg)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/22b8914f40a7c699584422470911b97f.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/645d8e093b17b3aac2468fcaec97390f.png)

read 调用图示：read、write 都是系统调用指令

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/40042009f50252bdfa6af58b79dd62ec.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/a74fe63f6bc858c1d8e9306933743324.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/8960cd5f99995dd1d38f52d5f987fd8d.png)
...
参考文章：[https://blog.csdn.net/hancoder/article/details/112149121](https://blog.csdn.net/hancoder/article/details/112149121)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/f1d8c2fb34cb7a9931c33d96286b995b.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/c12a84e0d27b4d9e1a31c5d4b2c2eca0.png)
...
三次握手后 TCP 连接建立成功，服务器内核会把连接从 SYN 半连接队列（一次握手时在服务端建立的队列）中移出，移入 accept 全连接队列，等待进程调用 accept 函数时把连接取出。如果进程不能及时调用 accept 函数，就会造成 accept 队列溢出，最终导致建立好的 TCP 连接被丢弃 ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/42057ba4f276685f5c6dd02f1d3f5cd1.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/56a86fa787610165ecb93801746c3322.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/841a14fa55807a3e558a44db52ef097a.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/68ba2f27bfd4ef656b26695bf2d93bbd.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/fe45187600719cac0b6a1a7cdc4c7bf4.png)
...
-  位置、限制、容量遵守以下不变式： **0 <= position <= limit <= capacity** ![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/d85f7faafb0ad564b7314eb67c1e3bd8.png) 
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/edcf02d4b9161d12dffff1f8d400f6d6.png)

![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/190cee5a90ac94a31b77eddb7ab17f2c.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/6cdd39ac1dfa9ec097b046be6e0a3a21.png)
...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/JUC/ec4f4c708411608c84c67434ed4a6c0b.png)
