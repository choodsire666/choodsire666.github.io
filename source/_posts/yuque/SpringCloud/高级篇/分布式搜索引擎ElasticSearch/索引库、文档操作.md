...
![image-20210720202707797.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/1002353fdcea157f4905b87019292fdf.png)
...
![image-20210720203022172.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/fa297f5e6ead56fdc14e6a4928955f6d.png)
...
![image-20210720203534945.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/bd5d37678af8c4cf9663784d5cc577ab.png)
## 1.4.安装es、kibana
### 1.4.1.安装
...
```
**示例**：
![image-20210720211019329.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/cf89e97d8a214678926d756166bff8fb.png)
### 2.2.3.修改索引库
...
```
**示例**：
![image-20210720212357390.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/d98a7c999d201d07e17c8efc57377392.png)
### 2.2.4.删除索引库
**语法：**
...
```
在kibana中测试：
![image-20210720212123420.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/296626e34986e5d4193a2a0150f58adc.png)
### 2.2.5.总结
索引库操作有哪些？
...
```
**响应：**
![image-20210720212933362.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/73d844e37b87de2675506b1ddca7ae58.png)
针对同一个index，其中version在每次写操作后都会+1（新增、修改、删除）
![ES文档新增没有age.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/665a606e86b3bcfeb6a9f0df07ba833c.png)
![ES文档新增有age（字段非空都返回）.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/e1f636893be0dca936f1d7ce5c989fd5.png)
## 3.2.查询文档
...
```
**查看结果：**
![image-20210720213345003.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/256eb28c014b834662b531e0d9d1a045.png)
## 3.3.删除文档
...
```
**结果：**
![image-20210720213634918.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/e2e5bb1ea3fce247a4766667906448c8.png)
## 3.4.修改文档
修改有两种方式：
...
项目结构如图：
![image-20210720220647541.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/c1966318508619569cef12ceabb525f3.png)
### 4.0.3.mapping映射分析
...
地理坐标说明：
![image-20210720222110126.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/ef458ec6bc980322adc105ff361c03d2.png)
copy_to说明：
...
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/dd58f0db08b124eae4193dd9550580be.png)
4）引入
```java
...
### 4.1.1.代码解读
创建索引库的API如下：
![image-20210720223049408.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/d2ae352ccc5856bf4368a8580e083808.png)
代码分为三步：
...
```
对应的java代码如图
![image-20210720230027240.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/472119f5d1e87bfc69a4ff98724224cd.png)
可以看到与创建索引库类似，同样是三步走：
...
![image-20210720230811674.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/0b2712fe63562434a2406737a87f8224.png)可以看到，结果是一个JSON，其中文档放在一个`_source`属性中，因此解析就是拿到`_source`，反序列化为Java对象即可。
与之前类似，也是三步走：
...
这里不再赘述，我们主要关注增量修改。
代码示例如图：
![image-20210720231040875.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/e6b06bbc2f3ea5c62ea6b675cc4c41a0.png)
...
![image-20210720232105943.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/eccdd605e0107e06cb87a0ac6321e230.png)
可以看到，能添加的请求包括：
...
![image-20210720232431383.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/3b6aad21b02a3795d45cbd9ac1d8d9bd.png)
其实还是三步走：
...
![数据批量导入验证结果.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/873d8f9d4cb66d8a01c0ad6f24c24338.png)
## 5.6.小结
文档操作的基本步骤：
