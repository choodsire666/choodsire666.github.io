...
```
这次，聚合得到的品牌明显变少了：
![image-20210723172404836.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/c935d3998d7fbc7dae82439f0248abb1.png)
### 1.2.4.Metric聚合语法
...
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/d8b8d0a4b272ea6bf10a6de1e15da674.png)
```json
GET /hotel/_search
{
  "size": 0,
...
聚合条件的语法：
![image-20210723173057733.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/090206e498bae3b6539b47e4e50fafd6.png)
聚合的结果也与查询结果不同，API也比较特殊。不过同样是JSON逐层解析：
![image-20210723173215728.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/256da3dc247a530ac834fbc2bfec9400.png)
完整代码如下：
```java
@Test
...
```
完整映射关系如下：
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/618e5a41cb9dce6b6fafa9d55fb153fc.png)
### 1.3.2.业务需求
需求：搜索页面的品牌、城市等信息不应该是在页面写死，而是通过聚合索引库中的酒店数据得来的：
![image-20210723192605566.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/e070267a5eaad10cf3a4709c1f4c645d.png)
...
![image-20210723193730799.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/1ab6fcaf7cf218f1c0f46dccc0e87e2e.png)
请求**参数与搜索文档的参数完全一致**。返回值类型就是页面要展示的最终结果：
![image-20210723203915982.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/7b1f4b2c3579ccfbe14be270a91e444b.png)
结果是一个Map结构：
...
![image-20210723205932746.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/d15d41893b149f9be638c7457e09d4b0.png)
安装方式与IK分词器一样，分三步：
①解压（课程资料已做，无需在做）
...
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/9c6c947fd9d56fd74f9469aea66aa4dc.png)
...
```
结果：
![image-20210723210126506.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/bc1dfe8c78df7837e937d178c350d222.png)
## 2.2.自定义分词器
...
文档分词时会依次由这三部分来处理文档：
![image-20210723210427878.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/052b406d1faf48515ebd86952c787cc9.png)
声明自定义分词器的语法如下：
```json
PUT /test
{
...
![image-20210723211829150.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/34f84ba48303b47619ac9d343e991039.png)![](assets/image-20210723211829150.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_9%2Ctext_5rK554K45bCP5rOi%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10#id=rHb98&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
如何使用拼音分词器？
...
![image-20210723213759922.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/51e23817b158fa57c9d2ff21fb1027c2.png)
而自动补全的结果也比较特殊，解析的代码如下：
![image-20210723213917524.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/311d9e5072881614d6ee2bd6f179b807.png)
### 2.4.5.实现搜索框自动补全
查看前端页面，可以发现当我们在输入框键入时，前端会发起ajax请求：
![image-20210723214021062.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/5027c94e02b460c04e666fc83b38cc9a.png)
...
![image-20210723214758392.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/f15b0b2c5787b0a1dbc770e3b397fbf0.png)
## 3.1.思路分析
常见的数据同步方案有三种：
...
### 3.1.3.监听binlog
方案三：监听binlog
![image-20210723215518541.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/61bfc12cf9b234218ec15ab7efcaebdc.png)
流程如下：
...
其中包含了酒店的CRUD功能：
![image-20210723220354464.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/4448e3fdb7f1422701ef3a11da7b9d4b.png)
如果新增失败，控制台提示的是：
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/1967e54e75cf0e2c0bd05f8505822ebe.png)
请修改表结构让其主键自增
```properties
alter table tb_hotel modify id bigint auto_increment comment '酒店id';
```
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/60e022e45291cb40fe25772ed9ec4e55.png)
### 3.2.3.声明交换机、队列
MQ结构如图：
![image-20210723215850307.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/886d1f366a0c15ec40b6f93961f12d15.png)
#### 1）引入依赖
...
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/5aac0b58cf161673b05f39c91a79ee39.png)
...
```
### 3.2.6.结果验证
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/d372bf0cbe883f1fe46832f8330352ce.png)
...
```
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/40c150fd7f290c27905fe58394ee5395.png)
删除后去kibana查看数据没了（执行上述命令会发现hits中是0）
![image.png](https://raw.githubusercontent.com/choodsire666/blog-img/main/e1d969ceaf0363e1a12edd7348cd8b30.png)
