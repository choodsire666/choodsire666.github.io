...
cover: 'https://raw.githubusercontent.com/choodsire666/blog-img/main/字段与表管理/cover.jpg'
---
## 结构数据
...
```
### createTable()
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/字段与表管理/35bd55ad40670b65846b41702f983177.png)
```java
/**
 * 创建一个新的数据库表。
 *
