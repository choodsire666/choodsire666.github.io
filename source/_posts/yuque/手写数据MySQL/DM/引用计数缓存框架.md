...
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/6f6a0bba18269a7d8b17c0d328080106.png)
```java
//从缓存中获取资源
...
#### release()
释放一个缓存
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/c0d1a2f8a0d3215f303827649f30da12.png)
```java
/**
 * 强行释放一个缓存
 */
...
#### close()
关闭缓存，释放所有缓存信息
![](https://raw.githubusercontent.com/choodsire666/blog-img/main/115b169c2b5741c963fcb7beef635d9f.png)
```java
/**
 * 关闭缓存，写回所有资源
 */
